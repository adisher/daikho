...
<?php $__env->startSection('title','Campaign Daily Report'); ?>
                                    ...
                                    <select class="select2 form-control custom-select" name="campaign" id="campaign" style="width: 100%; height:36px;" required>
                                        ...
                                        <optgroup label="Select Campaign">
                                            <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($campaign->source_id); ?>"><?php echo e($campaign->slug); ?></option>
...
//     }
  ...
  $('#reportForm').submit(function (e) { 
       ...
       var table = $('#footer_callback').DataTable();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('getreport')); ?>",
            data: {
   ...
   $(document).on({
    ...
    <?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ideation\deikhodashboard28323\deikhodashboard\resources\views/report.blade.php ENDPATH**/ ?>