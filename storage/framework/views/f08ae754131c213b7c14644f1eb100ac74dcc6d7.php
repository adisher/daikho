...
<?php $__env->startSection('title','Bulk Unsub'); ?>
...
<script src="<?php echo e(asset('assets/dist/js/pages/datatable/datatable-advanced.init.js')); ?>"></script>
    <script>
        ...
        $('#bulk-form').submit(function (e) { 
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('fileunsub')); ?>",
                data: formData,
                processData: false,
                contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mini_app/deikhodashboard/resources/views/user/bulkunsub.blade.php ENDPATH**/ ?>