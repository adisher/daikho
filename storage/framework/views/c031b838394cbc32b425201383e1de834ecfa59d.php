    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo e(asset('assets/images/big/auth-bg.jpg')); ?>) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="<?php echo e(asset('assets/images/play.png')); ?>" alt="logo" /></span>
                        <h5 class="font-medium m-b-20">Deikho Jazz - Sign In </h5>
                    </div>
                    ...
                    <div class="pgn-wrapper" data-position="bottom-right">
                      <div class="pgn push-on-sidebar-open pgn-flip">
                        <div class="alert alert-danger">
                          ...
                          </button><span><?php echo e($message); ?></span>
                        </div>
                      </div>
                    </div>
                    <?php endif; ?>
...
</html><?php /**PATH D:\Ideation\deikhodashboard28323\deikhodashboard\resources\views/auth/login.blade.php ENDPATH**/ ?>