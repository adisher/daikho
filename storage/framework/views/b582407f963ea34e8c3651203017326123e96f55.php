...
<?php $__env->startSection('title','SMS Unsub Report'); ?>
                                    ...
                                    <table id="footer_callback" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                                <tr>
                                                    ...
                                                    <th>Failed</th>
                                                    <th>Valid</th>
                                                    <th>Successful Unsubscriptions</th>
...
//     }
  ...
  $('#reportForm').submit(function (e) { 
       ...
       var table = $('#footer_callback').DataTable();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('getsmsreport')); ?>",
            data: {
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mini_app/deikhodashboard/resources/views/smsunsub.blade.php ENDPATH**/ ?>