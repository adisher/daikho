...
$(document).on('click',":checkbox",function(event){
             //console.log();
                ...
                $.ajax({
                   url:  "<?php echo e(url('updateStatus')); ?>" + '/' + event.target.id,
                   dataType: 'json',
                   type:  'POST',
  ...
  $('#reportForm').submit(function (e) { 
       ...
       var table = $('#footer_callback').DataTable();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('getdetailedreport')); ?>",
            data: {
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mini_app/deikhodashboard/resources/views/detailedreport.blade.php ENDPATH**/ ?>