...
//     }
  ...
  $('#reportForm').submit(function (e) { 
       ...
       var table = $('#footer_callback').DataTable();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('getdeikhoreport')); ?>",
            data: {
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mini_app/deikhodashboard/resources/views/deikho.blade.php ENDPATH**/ ?>