...
<?php $__env->startSection('title','Unsub Report'); ?>
...
//     }
  ...
  $('#reportForm').submit(function (e) { 
       ...
       var table = $('#footer_callback').DataTable();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('getunsubreport')); ?>",
            data: {
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mini_app/deikhodashboard/resources/views/unsubreport.blade.php ENDPATH**/ ?>