                                    ...
                                    <table id="footer_callback" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                                <tr>
                                                    ...
                                                    <th>Total Base</th>
                                                    <th>Active Users</th>
                                                    <th>Total Renewal Base</th>
                                                    <th>Revenue</th>
                                                    <th>Rev New Users</th>
                                                    <th>Revenue Returning Users</th>
                                                    <th>Unique Charged Users</th>
                                                    <th>Charging Success Rate</th>
                                                    <th>New Trials</th>
                                                    <th>New Subs</th>
                                                    <th>Subs Web</th>
                                                    <th>Subs App</th>
...
function populateTable(data){
    ...
    data.forEach(element => {
                 ...
                 table.row.add( [
                     element.reference_date,
                     element.user_base,
                     element.active_users,
                     (element.daily_renewal_base+element.weekly_renewal_base+element.monthly_renewal_base),
                     (element.daily_revenue+element.weekly_revenue+element.monthly_revenue+element.subs_revenue),
                     element.daily_revenue_new,
                     element.daily_revenue_returning,
                     element.daily_unique_charged,
                     element.success_rate_charging.toFixed(2),
                     element.new_trials,
                     element.new_trials,
                     element.subs_web,
                     element.subs_app,
                     element.total_streaming_minutes,
                     element.total_stream_counts
                     ] ).draw( false );
